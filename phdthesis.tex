...
\thispagestyle{plain} % No page number on quote page
...
\begin{tikzpicture}[remember picture, overlay]
  \node[fill=black, text=white, font=\bfseries\fontsize{50}{70}, anchor=east, minimum height=1.5cm, minimum width=2cm] at ($(current page.north east) + (0,-0.2\paperheight)$) {\I};
\end{tikzpicture}
